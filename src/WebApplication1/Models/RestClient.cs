...
namespace SM.Common.REST {
	/// <summary>
	/// A generic class that makes REST calls (GET, POST, DELETE) - PUT still not implemented.
	/// </summary>
	public class RestClient : IRestClient {
		...
		public string Delete(string id) {
			...
			var result = _client.DeleteAsync($"{EndpointMethod}{id}");
		...
		void Initialize() {
			...
			if (_client.BaseAddress == null) {
				// Only change the base address once.
